    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                elif dictBackButton['x+w'] > mouse[0] > dictBackButton['x'] and dictBackButton['y+h'] > mouse[1] > \
                        dictBackButton['y']:
                    if selectedPath > 0:
                        selectedPath = selectedPath - 1
                    else:
                ...
                elif dictPuzzleButton['x+w'] > mouse[0] > dictPuzzleButton['x'] and dictPuzzleButton['y+h'] > mouse[1] > \
                        dictPuzzleButton['y']:
                ...
                elif dictDownloadImageButton['x+w'] > mouse[0] > dictDownloadImageButton['x'] and \
                        dictDownloadImageButton['y+h'] > mouse[1] > dictDownloadImageButton['y']:
                    global downloading
                ...
                elif dictUploadImageButton['x+w'] > mouse[0] > dictUploadImageButton['x'] and dictUploadImageButton[
                    'y+h'] > mouse[1] > dictUploadImageButton['y']:
        ...
        button(dictLevelButton['text'], dictLevelButton['x'], dictLevelButton['y'], dictLevelButton['w'],
               dictLevelButton['h'], yellow, white)
        button(dictSurveyButton['text'], dictSurveyButton['x'], dictSurveyButton['y'], dictSurveyButton['w'],
               dictSurveyButton['h'], yellow, white)
        button(dictDownloadImageButton['text'], dictDownloadImageButton['x'], dictDownloadImageButton['y'],
               dictDownloadImageButton['w'], dictDownloadImageButton['h'], yellow, white)
        button(dictUploadImageButton['text'], dictUploadImageButton['x'], dictUploadImageButton['y'],
               dictUploadImageButton['w'], dictUploadImageButton['h'], yellow, white)  # "upload")
        button(dictInstructionButton['text'], dictInstructionButton['x'], dictInstructionButton['y'],
               dictInstructionButton['w'], dictInstructionButton['h'], yellow, white, "instructionsfile")
        button(dictPuzzleButton['text'], dictPuzzleButton['x'], dictPuzzleButton['y'], dictPuzzleButton['w'],
               dictPuzzleButton['h'], yellow, white, "play")
        button(dictBackButton['text'], dictBackButton['x'], dictBackButton['y'], dictBackButton['w'],
               dictBackButton['h'], yellow, white, "back")  # back button
        button(dictNextButton['text'], dictNextButton['x'], dictNextButton['y'], dictNextButton['w'],
               dictNextButton['h'], yellow, white, "next")  # next button
