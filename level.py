...
for i in range(1, 6):
    level_button = Button(master, compound="center", text=level[l], width=3, height=1, font=('arial 15 bold'),
                          highlightbackground="light blue", bg="light blue", fg='midnight blue',
